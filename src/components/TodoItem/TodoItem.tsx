...
type Props = {
  ...
  isOneChanges: boolean,
  setIsOneChanges: React.Dispatch<React.SetStateAction<boolean>>,
};
    ...
    >
      <label
        className={classNames('todo__status-label', {
          'todo__status-label--is-disabled': isOneChanges,
        })}
      >
        <input
          data-cy="TodoStatus"
